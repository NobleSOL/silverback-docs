...
### Concentrated Positions (V3)

V3 positions show additional information:
...
- V2/AMM: Auto-compounded into position (received on withdrawal)
- V3: Accumulate separately (claim anytime)
...
**Why is my V3 position out of range?**
