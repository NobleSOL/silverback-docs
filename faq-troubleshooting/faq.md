...
### Why does Keeta require localhost:3000?

The Keythings wallet extension only works with allowlisted URLs. Localhost:3000 is on the allowlist for development/testing. This requirement is temporary.
...
GitHub: [github.com/NobleSOL](https://github.com/NobleSOL)
...
Smart contracts follow established Uniswap V2 standards which are battle-tested. Additional audits may be conducted — check our announcements for updates.
